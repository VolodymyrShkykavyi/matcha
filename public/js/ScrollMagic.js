!function (e, t) {
   ...
   window.addEventListener("mousewheel", function () {
    ...
    e.Controller = function (r) {
        var o, s, a = "REVERSE", l = "PAUSED", c = n.defaults, u = this, f = i.extend({}, c, r), d = [], h = !1, p = 0,
            g = l, v = !0, m = 0, y = !0, w = function () {
        ...
        return this.addScene = function (t) {
            if (i.type.Array(t)) t.forEach(function (e) {
                u.addScene(e)
            }); else if (t instanceof e.Scene) if (t.controller() !== u) t.addTo(u); else if (d.indexOf(t) < 0) {
            ...
            return C({type: "resize"}), e && x(), u
        }, this.scrollTo = function (n, r) {
            if (i.type.Number(n)) E.call(f.container, n, r); else if (n instanceof e.Scene) n.controller() === u && u.scrollTo(n.scrollOffset(), r); else if (i.type.Function(n)) E = n; else {
                var o = i.get.elements(n)[0];
                if (o) {
                    for (; o.parentNode.hasAttribute(t);) o = o.parentNode;
                    var s = f.vertical ? "top" : "left", a = i.get.offset(f.container), l = i.get.offset(o);
    ...
    e.Controller.addOption = function (e, t) {
        ...
        this.on = function (e, t) {
            ...
            return t instanceof e.Controller && s != t && (s && s.removeScene(f), s = t, z(), S(!0), b(!0), w(), s.info("container").addEventListener("resize", E), t.addScene(f), f.trigger("add", {controller: s}), f.update()), f
        }, this.enabled = function (e) {
            ...
            } else L && h === l && A(!0); else s.updateScene(f, !1);
            return f
        }, this.refresh = function () {
            return S(), b(), f
        }, this.progress = function (e) {
            if (arguments.length) {
                var t = !1, n = h, r = s ? s.info("scrollDirection") : "PAUSED", i = d.reverse || e >= p;
                if (0 === d.duration ? (t = p != e, p = 1 > e && i ? 0 : 1, h = 0 === p ? a : l) : 0 > e && h !== a && i ? (p = 0, h = a, t = !0) : e >= 0 && 1 > e && i ? (p = e, h = l, t = !0) : e >= 1 && h !== c ? (p = 1, h = c, t = !0) : h !== l || i || A(), t) {
                    var o = {progress: p, state: h, scrollDirection: r}, u = h != n, g = function (e) {
                        f.trigger(e, o)
                    };
        ...
        var w = function () {
            g = {start: v + d.offset}, s && d.triggerElement && (g.start -= s.info("size") * d.triggerHook), g.end = g.start + d.duration
        }, S = function (e) {
            if (o) {
                var t = "duration";
                C(t, o.call(f)) && !e && (f.trigger("change", {what: t, newval: d[t]}), f.trigger("shift", {reason: t}))
            }
        }, b = function (e) {
        ...
        var A = function (e) {
            if (L && s) {
                var t = s.info(), n = T.spacer.firstChild;
                if (e || h !== l) {
                    ...
                    u[t.vertical ? "top" : "left"] += f, i.css(T.spacer.firstChild, {top: u.top, left: u.left})
                }
            }
        }, _ = function () {
            if (L && s && T.inFlow) {
                var e = h === l, t = s.info("vertical"), n = T.spacer.firstChild,
                    r = i.isMarginCollapseType(i.css(T.spacer, "display")), o = {};
                T.relSize.width || T.relSize.autoFullWidth ? e ? i.css(L, {width: i.get.width(T.spacer)}) : i.css(L, {width: "100%"}) : (o["min-width"] = i.get.width(t ? L : n, !0, !0), o.width = e ? o["min-width"] : "auto"), T.relSize.height ? e ? i.css(L, {height: i.get.height(T.spacer) - (T.pushFollowers ? d.duration : 0)}) : i.css(L, {height: "100%"}) : (o["min-height"] = i.get.height(t ? n : L, !0, !r), o.height = e ? o["min-height"] : "auto"), T.pushFollowers && (o["padding" + (t ? "Top" : "Left")] = d.duration * p, o["padding" + (t ? "Bottom" : "Right")] = d.duration * (1 - p)), i.css(T.spacer, o)
            }
        }, O = function () {
        ...
        this.setPin = function (e, n) {
            ...
            var a = "absolute" != i.css(L, "position"), l = i.css(L, s.concat(["display"])),
                c = i.css(L, ["width", "height"]);
            L.parentNode.style.display = o, !a && n.pushFollowers && (n.pushFollowers = !1);
            var u = L.parentNode.insertBefore(document.createElement("div"), L), d = i.extend(l, {
            ...
            return T.relSize.width && i.css(u, {width: c.width}), T.relSize.height && i.css(u, {height: c.height}), u.appendChild(L), i.css(L, {
                position: a ? "relative" : "absolute",
                margin: "auto",
                top: "auto",
                left: "auto",
    ...
    var i = e._util = function (e) {
        var t, n = {}, r = function (e) {
            ...
            if ((n = n === document ? e : n) === e) s = !1; else if (!f.DomElement(n)) return 0;
    ...
    e.Scene.extend(function () {
        var r, i, o, s, a = this, l = e._util, c = 0;
        ...
        var u = function (e, n, r) {
            l.type.Array(e) ? e.forEach(function (e) {
                u(e, n, r)
            }) : (t.Utilities.data(e, s) || t.Utilities.data(e, s, {reverseProps: l.css(e, Object.keys(i))}), t(e, n, r), void 0 !== r.queue && t.Utilities.dequeue(e, r.queue))
        }, f = function (e, n) {
        ...
        a.setVelocity = function (e, t, c) {
            ...
            return r && (void 0 !== o.queue && t(r, "stop", o.queue), e && f(r, {duration: 0}), r.forEach(function (e) {
